...
import library.customer.Transaction;

public class TransactionService {
    private static int IDcount = 0;
    private static final String transactionFile = "Transaction.data"; 
    ...
    public static void make(){/// change to confirm before make , and automaticlly add price and require pet ID
        ...
        int customerID = Utility.enterPositiveIntWithPromt("please enter customer's ID: ");
        ...
        int petID =  Utility.enterPositiveIntWithPromt("please enter pet's ID: ");
        ...
        transaction.display();
        String confirm = Utility.nextLineWithPromt("enter yes to confirm to make this transaction: ");
    ...
    public static void change(){
        ...
        switch (Utility.choice) {
            case 1:
                ...
                break;
            case 2:
                double newValue = Utility.enterPositiveDoubleWithPromt("please enter new value");
                transactionMap.get(ID).setValue(newValue);
                break;
            case 3:
                String newTime = Utility.nextLineWithPromt("please enter new Time");
